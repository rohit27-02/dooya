  ...
  return (
    ...
    <div className="text-[#252525]">
      ...
      <div style={{ fontFamily: `'Cormorant Garamond', serif` }} className="flex flex-col justify-evenly px-[8vw] -mt-[25vw] bg-white mx-[8vw] text-[4.6875vw] drop-shadow-xl h-[29vw] w-[50vw]">
        ...
        <div style={{ fontFamily: `"montserrat",sans-serif`, fontWeight: 700 }} className="text-[1.25vw] hover:text-[#32CD32] cursor-pointer  flex items-center ">
          <p> Learn More </p> <p className="text-[2vw] ml-[1vw]">→</p>
        </div>

      </div>

      <div className="flex ">
        <div className="w-[46vw] overflow-hidden ml-[8vw] mt-[8vw] drop-shadow-xl">
        ...
        <div className="drop-shadow-xl mt-[16vw] -mx-[3vw] mr-[8vw] h-[38vw] w-[47.5vw] bg-[#D5F3C1] flex flex-col justify-evenly px-[4vw]">
          <h1 className="text-[3.6vw]" style={{ fontFamily: `'Cormorant Garamond', serif` }}>Welcome</h1>
          <p  style={{fontFamily: `"montserrat",sans-serif`,}}>Dooya strives for excellence by providing customized solutions. Our knowledgeable experts selects the most genuine and experienced
vendors after in-depth research.</p>
<div style={{ fontFamily: `"montserrat",sans-serif`, fontWeight: 700 }} className="text-[1.25vw] hover:text-white  cursor-pointer  flex items-center ">
          <p> Learn More </p> <p className="text-[2vw] ml-[1vw]">→</p>
        </div>
        </div>
      </div>
